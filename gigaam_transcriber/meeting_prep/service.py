...
SYSTEM_PROMPT = (
    ...
    "1. Профиль компании\n"
    "2–3 предложения: чем занимается, основной ОКВЭД, масштаб (выручка/сотрудники если есть). "
    ...
    "7. Что мы предлагаем\n"
    "Для 2–3 наиболее релевантных продуктов из каталога:\n"
    "- Название и 1 предложение описания\n"
    "- Какую боль закрывает\n"
    "- Ключевое преимущество для данного клиента\n"
    "Ранжируй по приоритету предложения.\n\n"
    "─── БЛОК 3: ТАКТИКА ПРОВЕДЕНИЯ ───\n\n"
    "8. Вопросы к клиенту\n"
    "4–5 ключевых вопросов, наиболее важных для данной встречи. "
    "Для каждого — 1 предложение: зачем спрашиваем. "
    "Отсортируй по логике беседы.\n\n"
    "9. Возможные возражения и ответы\n"
    "2–3 наиболее вероятных возражения конкретно для данного клиента "
    "с конкретным контраргументом на каждое.\n\n"
